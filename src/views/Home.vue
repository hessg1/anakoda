              ...
              <v-layout row wrap>
                <v-flex xs12 md4>
                  <div class="title">
                    ...
                    Dashboard</div>
                  <p>Im Dashboard findest du einen Zeitstrahl,
                    auf dem alle deine erfassten Symptome und Kopfschmerzen angezeigt werden. Du kannst mit der Maus über die
                    einzelnen Einträge fahren, um die Details anzuzeigen. Im Kennzahlen-Tab berechnen wir dir einzelne Kennzahlen
                    aus deinen Daten. Erfahre, wie sich diese im Lauf der Zeit verändern!</p>
                </v-flex>
                <v-flex xs12 md4>
                  <div class="title">
